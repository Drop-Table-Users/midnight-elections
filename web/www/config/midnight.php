...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Elections API Configuration
    |--------------------------------------------------------------------------
    |
    | Configuration for the elections-api server that handles contract interactions.
    |
    */
    'elections_api' => [
        'base_uri' => env('MIDNIGHT_ELECTIONS_API_URI', 'http://localhost:3000'),
        'timeout' => (float) env('MIDNIGHT_ELECTIONS_API_TIMEOUT', 30.0),
    ],
];
