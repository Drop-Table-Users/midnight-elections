    ...
    <header>
        <div class="container">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <h1>{{ __('elections.admin.create.title') }}</h1>
            ...
            <form action="{{ route('admin.elections.store') }}" method="POST">
                ...
                <div class="language-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="title_sk" name="title_sk" value="{{ old('title_sk') }}" required>
                    </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary">{{ __('elections.admin.create.submit') }}</button>
                    <a href="{{ route('admin.dashboard') }}" class="btn btn-secondary">{{ __('elections.admin.create.cancel') }}</a>
                </div>
            </form>
        </div>
    </div>
